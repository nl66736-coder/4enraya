/**
 * SimuladorPartidas: enfrenta dos jugadores en N partidas y devuelve
 * estadísticas.
 *
 * Alterna quién empieza en cada partida (la mitad empieza jugador1, la otra
 * mitad jugador2).
 * Registra victorias/derrotas/empates, tiempo medio de búsqueda y nodos
 * generados.
 */
public class SimuladorPartidas {
    ...
    public static class Resultado {
        ...
        public double nodosMediaJ1() {
            return movimientosJ1 == 0 ? 0 : (double) nodosJ1Total / movimientosJ1;
        }

        public double nodosMediaJ2() {
            return movimientosJ2 == 0 ? 0 : (double) nodosJ2Total / movimientosJ2;
        }

        public double tiempoMediaJ1Ms() {
            return movimientosJ1 == 0 ? 0 : (double) tiempoJ1TotalMs / movimientosJ1;
        }

        public double tiempoMediaJ2Ms() {
            return movimientosJ2 == 0 ? 0 : (double) tiempoJ2TotalMs / movimientosJ2;
        }

        @Override
        public String toString() {
            return String.format(
                    "Partidas: %d | Victorias J1: %d (%.1f%%) | Victorias J2: %d (%.1f%%) | Empates: %d (%.1f%%) | Tiempo medio: %.1f ms/partida | J1 -> %.1f ms/mov | %.1f nodos/mov | J2 -> %.1f ms/mov | %.1f nodos/mov",
                    totalPartidas,
    ...
    private static void jugarPartida(Jugador jugador1, Jugador jugador2,
            Tablero tablero, boolean j1Empieza, Resultado resultado) {

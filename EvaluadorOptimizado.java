...
/**
 * EvaluadorOptimizado: extiende Evaluador usando pesos ajustados automáticamente
...
public class EvaluadorOptimizado extends Evaluador {
    ...
    /**
     * Evalúa el tablero desde la perspectiva de 'jugador' usando los pesos actuales.
    ...
    private List<PesosEvaluacion> generarVecinos(PesosEvaluacion base) {
        ...
        vecinos.add(new PesosEvaluacion(base.pesoLineas2 * f, base.pesoCentro,     base.pesoTriples,     base.pesoAmenazasDobles));
        vecinos.add(new PesosEvaluacion(base.pesoLineas2 * d, base.pesoCentro,     base.pesoTriples,     base.pesoAmenazasDobles));
        vecinos.add(new PesosEvaluacion(base.pesoLineas2,     base.pesoCentro * f, base.pesoTriples,     base.pesoAmenazasDobles));
        vecinos.add(new PesosEvaluacion(base.pesoLineas2,     base.pesoCentro * d, base.pesoTriples,     base.pesoAmenazasDobles));
        vecinos.add(new PesosEvaluacion(base.pesoLineas2,     base.pesoCentro,     base.pesoTriples * f, base.pesoAmenazasDobles));
        vecinos.add(new PesosEvaluacion(base.pesoLineas2,     base.pesoCentro,     base.pesoTriples * d, base.pesoAmenazasDobles));
        vecinos.add(new PesosEvaluacion(base.pesoLineas2,     base.pesoCentro,     base.pesoTriples,     base.pesoAmenazasDobles * f));
        vecinos.add(new PesosEvaluacion(base.pesoLineas2,     base.pesoCentro,     base.pesoTriples,     base.pesoAmenazasDobles * d));

        return vecinos;
    }

    /**
     * Enfrenta dos conjuntos de pesos en NUM_PARTIDAS partidas alternando quién empieza.
